...
<a href="https://packagist.org/packages/laravel-core-modules/laravel-service-repository"><img src="https://img.shields.io/packagist/dt/laravel-core-modules/laravel-service-repository.svg?style=flat-square" alt="Packagist downloads"></a>
...
```php
use LaravelCoreModule\ServiceRepository\Tests\Repositories\RoleRepository;
...
Run the following command to publish the stub files to the `Modules` folder in the root of your application.
